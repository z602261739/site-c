    ...
    [`rows|${query.limit || 10}`]: [
      {
        //当前页的列表数据
        id: '@guid', //全局随机id
        title: '@ctitle(1,27)', //随机生成一个中文标题
        description: '@cparagraph(1,10)', // 随机生成1到10个句子的一个段落
        category: {
          'id|1-10': 0,
          name: '分类@id'
        },
      ...
      [`rows|${query.limit || 10}`]: [
        {
          ...
          createDate: Date.now(),
          'avatar|1': [
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar1.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar2.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar3.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar4.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar5.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar6.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar7.jpg',
            'https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar8.jpg'
          ]
        }
      ]
